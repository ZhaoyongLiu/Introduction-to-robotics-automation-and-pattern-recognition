...
A1=[-0.8 0.2;-0.5 -0.3]; A2=[-0.4 0.5;-0.2 -0.5]; % system matrices
dimn=length(A1);
lambda=0.525; mu=1.672;  % parameters
...
p2 = lmivar(1,[dimn 1]); 
%%
lmiterm([1 1 1 p1],A1',A1); % LMI #1
lmiterm([1 1 1 p1],-lambda,1);
%%
lmiterm([2 1 1 p2],A2',A2); % LMI #2
