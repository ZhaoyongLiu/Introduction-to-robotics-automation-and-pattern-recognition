...
clc;clearvars 
LMIs=6; 
h=1.8680;   % the upper bound of tau(t)
...
lmiterm([1 1 3 S12],1,1);
lmiterm([1 3 3 S],-1,1);
lmiterm([1 3 3 R],-1,1);

lmiterm([1 1 4 R],1,1);
lmiterm([1 1 4 S12],-1,1);
lmiterm([1 1 4 -P2],1,A1);
lmiterm([1 2 4 -P3],1,A1);
lmiterm([1 3 4 R],1,1);
lmiterm([1 3 4 -S12],-1,1);
lmiterm([1 4 4 R],-2,1);
lmiterm([1 4 4 S12],1,1,'s');
lmiterm([1 4 4 Q],-(1-d),1);

%%
lmiterm([-2 1 1 R],1,1); 
lmiterm([-2 1 2 S12],1,1); 
lmiterm([-2 2 2 R],1,1); 
%%
lmiterm([-3 1 1 P],1,1); 
%%
